...
void setWidget::resetWindowView()
{
	...
	viewPainter.drawText(0, 0, 360, 58, Qt::AlignVCenter | Qt::AlignLeft, u8"AStream，传播好声音");
	viewPainter.setPen(tempPlayed);
	viewPainter.drawText(0, 0, font.pixelSize() * 5, 58, Qt::AlignVCenter | Qt::AlignLeft, u8"AStream，传播好声音");
